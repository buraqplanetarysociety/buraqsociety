      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative bg-black rounded-2xl overflow-hidden shadow-2xl">
            <div className="aspect-video relative">
              {!isVideoLoaded ? (
                <>
                  <Image
                    src="https://img.youtube.com/vi/nmkjbiPDGJQ/maxresdefault.jpg"
                    alt="2025 Buraq Space Camp"
                    width={0}
                    height={0}
                ...
                <iframe
                  src="https://www.youtube.com/embed/nmkjbiPDGJQ?autoplay=1&rel=0&modestbranding=1"
                  title="2025 Buraq Space Camp"
          ...
          <div className="mt-6 flex justify-center">
            <a
              href="https://www.youtube.com/watch?v=nmkjbiPDGJQ"
              target="_blank"
